...
class  ReportDataDormitoryPeriodTimeHeader extends CI_Controller {
	function __construct(){
		parent:: __construct();
		$this->load->model('report_data_dormitory_period_time_header_model', 'report_data_dormitory_period_time_header_model');
	...
	{
	    $result = $this->report_data_dormitory_period_time_header_model->showAll();
		echo json_encode($result);
	}
	public function btweendate()
	{
		$result = $this->report_data_dormitory_period_time_header_model->btweendate();
		
		echo json_encode($result);
	}
	
	public function checkkey(){
	    $result = $this->report_data_dormitory_period_time_header_model->checkkey();
	    if($result){
	        $msg['success'] = true;
