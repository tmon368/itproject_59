...
class ReportDataTeacher extends CI_Controller {
	function __construct(){
		parent:: __construct();
		$this->load->model('report_data_teacher_model', 'report_data_teacher_model');
	...
	public function showAll()
	{
	    ...
	    $result = $this->report_data_teacher_model->showAll();
		echo json_encode($result);
	}
	
	
	public function checkkey(){
	    $result = $this->report_data_teacher_model->checkkey();
	    if($result){
	        $msg['success'] = true;
