...
class ReportDataPlaceDisciplineOfficer extends CI_Controller {
	function __construct(){
		parent:: __construct();
		$this->load->model('report_data_place_discipline_officer_model', 'report_data_place_discipline_officer_model');
	...
	public function showAll()
	{
	    ...
	    $result = $this->report_data_place_discipline_officer_model->showAll();
		echo json_encode($result);
	}
	
	public function checkkey(){
	    $result = $this->report_data_place_discipline_officer_model->checkkey();
	    if($result){
	        $msg['success'] = true;
