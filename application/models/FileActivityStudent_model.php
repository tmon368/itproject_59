...
class FileActivityStudent_model extends CI_Model {
    ...
    public function selectparticipationactivities(){
        ...
        $status = 1;
        $this->db->select('p.par_ID,p.confirm_name,p.certificat_date,p.activity_time,s.std_fname,s.std_lname,s.email,s.phone,s.behavior_score,sv.service_name,sv.place,sv.service_date,sv.start_time,sv.end_time');
