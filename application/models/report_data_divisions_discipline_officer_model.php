...
class report_data_divisions_discipline_officer_model extends CI_Model {
 ...
 public function showAll(){
  ...
  // $this->db->where('oc.oc_ID',$oc_ID);
   $this->db->order_by('d.dept_ID','ASC');
   ...
   foreach ($data as $key=>$value){
      ...
      if ($value['dept_ID'] != $chk_deptID){
         $count = 1;
         $chk_deptID = $value['dept_ID'];
