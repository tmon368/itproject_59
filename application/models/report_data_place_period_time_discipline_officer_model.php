...
class report_data_place_period_time_discipline_officer_model extends CI_Model {
   ...
   $this->db->where('p.place_ID', $place_ID);
   ...
   foreach ($data as $key=>$value){
      ...
      if ($value['committed_date'] != $chk_offID){
         $count = 1;
         $chk_offID = $value['committed_date'];
