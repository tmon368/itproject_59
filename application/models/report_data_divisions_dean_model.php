...
class report_data_divisions_dean_model extends CI_Model {
 ...
 public function showAll(){
  ...
  // $this->db->where('oc.oc_ID',$oc_ID);
   ...
   foreach ($data as $key=>$value){
      ...
      if ($value['cur_ID'] != $chk_deptD){
         $count = 1;
         $chk_deptD = $value['cur_ID'];
