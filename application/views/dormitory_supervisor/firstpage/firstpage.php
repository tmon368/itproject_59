...
<html lang="en">
<link rel="stylesheet"
	href="<?php echo base_url('re/css/css_user_security.css'); ?>">
<script type="text/javascript"
	src="https://code.jquery.com/jquery-3.4.1.min.js"></script>
<script type="text/javascript"
	src="https://canvasjs.com/assets/script/canvasjs.min.js"></script>
<link rel="stylesheet"
	href="<?php echo base_url('re/css/load_style.css') ?>">
<link rel="stylesheet"
	href="<?php echo base_url('re/css/css_regis_activity_student.css') ?>">

<center>
	<strong><div class="alert alert-success" role="alert"
			style="display: none;"></div></strong> <strong><div
			class="alert alert-danger" role="alert" style="display: none;"></div></strong>
	<strong><div class="alert alert-warning" role="alert"
...
<body>
					...
					<div class="card shadow mb-4">
						...
						<div class="card shadow mb-3">
							<div class="card-body " id="card_1">
								...
								<br>
								<center>
									<i class="fas fa-users" id="fasfa-users"></i><br>
									<div id="showscorestudent" name="showscorestudent"></div>
									<br>
								</center>
				...
				<div class="col-lg-12 ">
					<div class="card shadow mb-3">
						<div class="card shadow mb-4">
							...
							<div class="card-body " id="card_1">
								<font size="2"><center>นักศึกษาที่มีคะแนนคงเหลือน้อยที่สุด 5
										ลำดับ</center></font> <br>
								<center>
									<div class="row">
										<div class="col-sm-12">
  ...
  window.onload = function () {
    ...
    chart.render();
					...
					<div class="col-lg-7 ">
						<font size="4"><div class="card-header" id="card_2">
								<h6 class="m-0 text-primary"></h6>
							</div> <br>
							<center>กิจกรรมเพิ่มเติม</center></font>
						<div class="btn btn-inverse-success btn-fw" id="btnAdd"
							data-toggle="modal">
							<ul>
								<li><font size="4"><center>กิจกรรมบำเพ็ญประโยชน์</center></font><br>
						...
						&nbsp;&nbsp;&nbsp;
						<div class="btn btn-inverse-warning btn-fw" id="btnedd"
							data-toggle="modal">
							<ul style="padding-right: 50px">
								<li><font size="4"><center>กิจกรรมการอบรม</center></font><br> <i
									class="fas fa-chalkboard-teacher" id="fasfa-chalkboard-teacher"></i>
						...
						<div class="modal fade" id="exampleModalCenter" tabindex="-1"
							...
							<div class="modal-dialog modal-dialog-centered"
								style="max-width: 620px !important;" role="document">
								<div class="modal-content">
									...
									<div class="modal-body">
										...
										<form action="1" id="formadd" method="post"
											class="needs-validation">
											<div class="form-group" id="input_group_sty">
												<div class="input-group">


													<div class="ShowActivity"></div>
							...
							<div class="modal-dialog modal-dialog-centered"
								...
								<div class="modal-content">
									...
									<div class="modal-body">
										...
										<form action="2" id="formedd" method="post"
											class="needs-validation">
											<div class="form-group" id="input_group_sty">
												<div class="input-group">


													<div class="ShowActivity2"></div>
