...
<head>
<title>ที่ปรึกษาหอพัก | ระบบวินัยนักศึกษามหาวิทยาลัยวลัยลักษณ์</title>
<style type='text/css'>
            ...
            <div class="col-lg-12 ">
                <div class="card shadow mb-4">
                    ...
                    <div class="card shadow mb-3">
                        <div class="card-body " id="card_1">
                            <font size="4">
                                <center>จำนวนนักศึกษาที่กระทำผิดแต่ละหมวดของหอพัก<span id="dname"></span></center>
                            </font>
                            <br><br>
            ...
            <div class="modal-content">
                <div class="card-header1" id="card_2">
                    ...
                    <h4 class="m-0 text-primary" id="exampleModalLongTitle">
                        <font size="5">&nbsp;&nbsp;รายละเอียดของนักศึกษาที่มีคะแนนเหลือน้อยที่สุด 10 อันดับ</font>
                    </h4>
        ...
        //                            data[i].behavior_score + '&nbsp;' + 'คะแนน' + '</div>';
         ...
         html += '<div class="bggreen">'+'<div class="Data1"> ' + '<div class="Main6">' + n  +'</div>'+ '<div class="Main7">' + " " + data[i].prefix_name + data[i].std_fname + '&nbsp;' + data[i].std_lname + '<br>' + 'คะแนนคงเหลือ' +
            ...
            function show_ell() {
                ...
                $.ajax({
                    type: 'POST',
                    url: '<?php echo site_url("dormitory_advisor_dashboard/showactity") ?>',
                    dataType: 'json',
                    success: function(data) {
                        console.log(data);
                        $.each(data, function(key, value) {
