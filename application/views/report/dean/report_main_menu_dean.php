        ...
        <div class="row col-lg-">
            <div class="col-lg-6 grid-margin stretch-card">
                <div class="card shadow mb-4">
                    ...
                    &nbsp;&nbsp;รายเดือน
                    <a href="<?php echo site_url('ReportDataDivisionsDean') ?>"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-check-square" aria-hidden="true"></i> รายงานนักศึกษาที่กระทำความผิดแยกตามหลักสูตร</a>
                  
                    </br>
                    &nbsp;&nbsp;ตามช่วงเวลา
                    <a href="<?php echo site_url('ReportDataDivisionsPeriodTimeDean') ?>"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-calendar-o" aria-hidden="true"></i> รายงานนักศึกษาที่กระทำความผิดแยกตามหลักสูตร</a>
            ...
            <div class="col-lg-6 grid-margin stretch-card">
                <div class="card shadow mb-4">
                    ...
                    <a href="<?php echo site_url('ReportChartcurriculumyearHeader  ') ?>"> &nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-bar-chart"></i> กราฟเปรียบเทียบสถิตินักศึกษาที่กระทำความผิดจำแนกตามหลักสูตร </a>
