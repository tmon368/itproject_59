            ...
            <div class="col-lg-10 grid-margin stretch-card">
                <div class="card shadow mb-4">
                    <div class="card-header" id="card_2">
                        <h6 class="m-0 text-primary"><span><i class="#"></i></span>&nbsp;รายงานนักศึกษาที่กระทำความผิดหลักสูตรอาเซียน ประจำเดือน มีนาคม 2563</h6>
                    </div>
                    <div class="card-body">
...
<script>
    $(document).ready(function() {
        ...
        function showAll() {
            $.ajax({
                type: 'ajax',
                url: '<?php echo base_url() ?>index.php/ReportDeanCurriculum/showAll',
                async: false,
                dataType: 'json',
        ...
        function getCurriculumSetInDropdownlists() {
            var htmlcode = '';
            $.ajax({
                url: '<?php echo site_url('getOffenseCate/selecgetCurriculum_info') ?>',
                type: 'GET',
                async: false,
                dataType: 'json',
                success: function(data) {
        ...
        $('#search_data').click(function() {
            ...
            $.ajax({
                url: '<?php echo site_url('ReportDeanCurriculum/getCUR_ID') ?>',
                type: 'GET',
                async: false,
                dataType: 'json',
                data:data,
