    ...
    <div class="container-fluid">
        ...
        <div class="page-breadcrumb" id="nav_sty">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="<?php echo site_url('dormitory_advisor_dashboard') ?>" class="breadcrumb-link">หน้าแรก</a></li>
            ...
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card shadow mb-4">
                    ...
                    <div class="HeaderReport">
                        ...
                        <br>
                        <h2>
                            <center>รายงานนักศึกษาที่กระทำความผิดหอพักลักษฯานิเวศ 7 ประจำเดือน <span class="MontsNameYear"></span>
                        </h2>
                        </center>
        ...
        <script type="text/javascript">
            ...
            function showall() {
                ...
                $.ajax({
                    url: '<?php echo site_url('ReportDataDormitoryDormitoryAdvisor/showall') ?>',
                    type: 'GET',
                    async: false,
                    dataType: 'json',
                    data: data,
