    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-10 grid-margin stretch-card">
                <div class="card shadow mb-4">
                    <div class="card-header" id="card_2">
                        <h6 class="m-0 text-primary"><span><i class="#"></i></span>&nbsp;รายงานนักศึกษาที่กระทำความผิดแยกตามหอพัก ประจำเดือน มีนาคม 2563</h6>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-lg-2 grid-margin stretch-card">
                <div>
                    <select name="dormid" id="dormid" class="form-control"></select>
...
<script>
    $(document).ready(function() {
        ...
        showAll();
        getDormitoryCateSetInDropdownlists();
        $('#tblName').DataTable();
        autoFill: true
        ...
        function showAll() {
            $.ajax({
                type: 'ajax',
                url: '<?php echo base_url() ?>index.php/dormad/showAll',
                async: false,
                dataType: 'json',
        ...
        function getDormitoryCateSetInDropdownlists() {
            var htmlcode = '';
            $.ajax({
        ...
        $('#search_data').click(function() {
            ...
            $.ajax({
                url: '<?php echo site_url('offd/getDORM_ID') ?>',
                type: 'GET',
                async: false,
                dataType: 'json',
                data:data,
