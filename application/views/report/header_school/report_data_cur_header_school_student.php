            ...
            <div class="col-lg-11 grid-margin stretch-card">
                <div class="card shadow mb-4">
                    <div class="card-header" id="card_2">
                        <h6 class="m-0 text-primary"><span><i class="#"></i></span>&nbsp;รายชื่อนักศึกษาที่กระทำความผิดหลักสูตรการท่องเที่ยวและการโรงแรม ประจำเดือน มีนาคม 2563</h6>
                    </div>
                    <div class="card-body">
...
<script>
    $(document).ready(function() {
        ...
        function showAll() {
            $.ajax({
                type: 'ajax',
                url: '<?php echo base_url() ?>index.php/ReportCurriHeaderSchool/showAll',
                async: false,
                dataType: 'json',
