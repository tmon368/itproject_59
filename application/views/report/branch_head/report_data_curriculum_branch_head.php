    ...
    <div class="container-fluid">
        ...
        <div class="page-breadcrumb" id="nav_sty">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="<?php echo site_url('Branch_head_dashboard') ?>" class="breadcrumb-link">หน้าแรก</a></li>
            ...
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card shadow mb-4">
                    ...
                    <div class="HeaderReport">
                        ...
                        <br>
                        <h2>
                            <center>รายงานนักศึกษาที่กระทำความผิดหลักสูตรเทคโนโลยีสารสนเทศ ประจำเดือน <span class="MontsNameYear"></span>
                        </h2>
                        </center>
                        ...
                        <colgroup>
                            ...
                            <thead class="table-active">
                                <tr>
                                    ...
                                    <th style="text-align:center">อาจารย์ที่ปรึกษา</th> 
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                $('#data_activity_participants').DataTable({
                    ...
                    columns: [{
                        ...
                        {
                            data: 'person_name', class: 'text-left'
                        }
                    ...
                    "drawCallback": function(settings) {
                        ...
                        api.column(groupColumn, {
                            ...
                            if (last !== group) {
                                console.log(group);
                                $(rows).eq(i).before('<tr class="group HeaderGroup"><td colspan="7">'+'ฐานความผิด : ' + group + '</td></tr>');
                                last = group;
                            }
                        });
            ...
            function showall() {
                ...
                $.ajax({
                    url: '<?php echo site_url('ReportDataCurriculumBranchHead/showall') ?>',
                    type: 'GET',
                    async: false,
                    dataType: 'json',
                    data: data,
