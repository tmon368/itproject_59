            ...
            <div class="col-lg-5 grid-margin stretch-card">
                <div class="card shadow mb-10" >
                    ...
                    <div class="card-body">
                        ...
                        <a href="<?php echo site_url('offc') ?>" class="breadcrumb-link" > &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;รายงานนักศึกษาที่กระทำความผิดทั้งหอพัก (รายเดือน)</a></span> </br>
                         <a href="<?php echo site_url('offctime') ?>" class="breadcrumb-link">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;รายงานนักศึกษาที่กระทำความผิดทั้งหอพัก(ตามช่วงเวลา)</a> </br>
                         
                        </div>
                    <div class="card-body">
                    <i class="fa fa-bar-chart" style="font-size:24px">&nbsp;&nbsp;&nbsp;กราฟ</i></br>
                    <a href="<?php echo site_url('offcate') ?>" class="breadcrumb-link">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;จำนวนนักศึกษาที่กระทำความทุกหมวดความผิด (รายเดือน) </br>
