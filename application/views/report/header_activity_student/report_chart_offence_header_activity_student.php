...
<body>
    <div class="container-fluid">
		...
		<div class="card-header" id="card_2">
                    <h6 class="m-0 text-primary"><span><i class="#"></i></span>&nbsp;จำนวนนักศึกษาที่กระทำผิดทุกฐานความผิด</h6>
                </div>
<div class="card-body">
...
var html = [];
	   ...
	   $.ajax({
           type: 'ajax',
           url: '<?php echo base_url() ?>index.php/ReportChartOffenceHeaderActivityStudent/chartOffense',
           async: false,
           dataType: 'json',
