...
<body>
<form action="<?php echo site_url("ReportChartOffencemonthHeader")?>">
...
var html = [];
var chart_name = "สถิตินักศึกษาที่กระทำผิดของฐานความผิด ประจำเดือน "+ monthThai(sel_month)+" ปี "+ sel_year + "";
