...
<script>
    $(document).ready(function() {
        ...
        function showAll() {
            $.ajax({
                type: 'ajax',
                url: '<?php echo base_url() ?>index.php/ReportOffenceHeaderActivityStudent/showAll',
                async: false,
                dataType: 'json',
                success: function(data) {
                    ...
                    for (i = 0; i < data.length; i++) {
                        html += '<tr>' +
                            ...
                            '<td align="center">' + n + ' </center></td>' +
                            '<td> ' + data[i].S_ID + '</center></td>' +
                            '<td> ' + data[i].std_fname + '</td>' +
                            '<td> ' + data[i].std_lname + '</td>' +
                            '<td  align="left">' + data[i].behavior_score + '</left></td>' +
        ...
        $('#search_data').click(function() {
            ...
            $.ajax({
                url: '<?php echo site_url('ReportOffenceHeaderActivityStudent/getOFF_ID') ?>',
                type: 'GET',
                async: false,
                dataType: 'json',
                data:data,
