...
function gen_graph(sel_year,sel_month,sel_year2,sel_month2) {		
    var html = [];
    var html2 = [];
var chart_name = "สถิตินักศึกษาที่กระทำความผิดแยกตามหลักสูตร  ระหว่างเดือน "+ monthThai(sel_month)+" ปี "+ sel_year + " กับ " + monthThai(sel_month2)+" ปี "+ sel_year2;
...
$('#yearmonthname2').html(monthThai(sel_month2)+" ปี "+ sel_year2);
	   ...
	   $.ajax({
           type: 'ajax',
           url: '<?php echo base_url() ?>index.php/ReportChartcurriculumcompareHeader/chartcur?sel_month='+sel_month+'&sel_year='+sel_year,
           async: false,
           dataType: 'json',
           success: function(data) {
               ...
               for (i = 0; i < data.length; i++) {
                ...
                $.ajax({
           type: 'ajax',
           url: '<?php echo base_url() ?>index.php/ReportChartcurriculumcompareHeader/chartcur?sel_month='+sel_month2+'&sel_year='+sel_year2,
           async: false,
           dataType: 'json',
           success: function(data) {
