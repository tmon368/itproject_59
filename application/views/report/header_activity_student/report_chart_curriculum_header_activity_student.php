...
<body>
    <div class="container-fluid">
		...
		<div class="card-header" id="card_2">
                    <h6 class="m-0 text-primary"><span><i class="#"></i></span>&nbsp;จำนวนนักศึกษาที่กระทำผิดทุกหลักสูตร ประจำเดือน มีนาคม 2563</h6>
                </div>
<div class="card-body">
...
var html = [];
	   ...
	   $.ajax({
           type: 'ajax',
           url: '<?php echo base_url() ?>index.php/dean_g/chartdivi',
           async: false,
           dataType: 'json',
