    ...
    <div class="container-fluid">
        ...
        <div class="page-breadcrumb" id="nav_sty">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="<?php echo site_url("head_menu") ?>" class="breadcrumb-link">หน้าแรก</a></li>
                    <li class="breadcrumb-item active" aria-current="page">ออกรายงาน</li>
                </ol>
            </nav>
        </div>
		<div class="card-header" id="card_2">
                    <h6 class="m-0 text-primary"><span><i class="#"></i></span>&nbsp;จำนวนนักศึกษาที่กระทำผิดทุกหมวดความผิด ประจำเดือน มีนาคม 2563</h6>
                </div>
<div class="card-body">
	<script src="<?php echo base_url('re/js/canvasjs.js') ?>"> </script>
...
var html = [];
	   ...
	   $.ajax({
           type: 'ajax',
           url: '<?php echo base_url() ?>index.php/ReportOffenceHeaderActivityStudent/chart',
           async: false,
           dataType: 'json',
