    ...
    <div class="container-fluid">
        ...
        <div class="page-breadcrumb" id="nav_sty">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="<?php echo site_url('ReportMenuHeader') ?>" class="breadcrumb-link">หน้าแรก</a></li>
            ...
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card shadow mb-4">
                    ...
                    <div class="HeaderReport">
                        ...
                        <br>
                        <h2>
                            <center>รายชื่อนักศึกษาที่กระทำความผิด ประจำเดือน <span class="MontsNameYear"></span>
                        </h2>
                        </center>
                        ...
                        <br>
                        <footer class="date_print">วันที่พิมพ์ <span class="DateCur"></span> </footer>
                    </div>
                </div>
        ...
        <script type="text/javascript">
                ...
                $('#data_activity_participants').DataTable({
                    ...
                    "drawCallback": function(settings) {
                        ...
                        api.column(groupColumn, {
                            ...
                            if (last !== group) {
                                console.log(group);
                                $(rows).eq(i).before('<tr class="group HeaderGroup"><td colspan="5">'+'ฐานความผิด :' + group + '</td></tr>');
                                last = group;
                            }
                        });
            ...
            function showall() {
                ...
                $.ajax({
                    url: '<?php echo site_url('ReportDataTeacher/showall') ?>',
                    type: 'GET',
                    async: false,
                    dataType: 'json',
                    data: data,
