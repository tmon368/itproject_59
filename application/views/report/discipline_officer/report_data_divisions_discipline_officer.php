            ...
            <div class="col-lg-9 grid-margin stretch-card">
                <div class="card shadow mb-4">
                    <div class="card-header" id="card_2">
                        <h6 class="m-0 text-primary"><span><i class="#"></i></span>&nbsp;รายงานนักศึกษาที่กระทำความผิดแยกตามสำนักวิชา ประจำเดือน มีนาคม 2563</h6>
                    </div>
                ...
                <div class="col-lg-2 grid-margin stretch-card">
                    <div>
                        <select name="deptid" id="deptid" class="form-control"></select>
...
<script>
    $(document).ready(function() {
        ...
        function showAll() {
            $.ajax({
                type: 'ajax',
                url: '<?php echo base_url() ?>index.php/dv/showAll',
                async: false,
                dataType: 'json',
        ...
        $('#search_data').click(function() {
            ...
            $.ajax({
                url: '<?php echo site_url('dv/getDEPT_ID') ?>',
                type: 'GET',
                async: false,
                dataType: 'json',
                data: data,
