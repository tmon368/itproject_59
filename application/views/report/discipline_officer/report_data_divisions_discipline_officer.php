    ...
    <div class="container-fluid">
            ...
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <br>
                        <h2>
                            <center>รายงานนักศึกษาที่กระทำความผิดจำแนกตามสำนักวิชา ประจำเดือน <span class="MontsNameYear"></span>
                        </h2>
                        </center>
                        <table id="data_activity_participants" class="table table-striped table-bordered" style="width:100%">
                            ...
                            <thead class="table-active">
                                <tr>
                                    ...
                                    <th style="text-align:center">สำนักวิชา</th>
        ...
        <script type="text/javascript">
                ...
                $('#data_activity_participants').DataTable({
                    ...
                    "drawCallback": function(settings) {
                        ...
                        api.column(groupColumn, {
                            ...
                            if (last !== group) {
                                console.log(group);
                                $(rows).eq(i).before('<tr class="group HeaderGroup"><td colspan="9">' + 'สำนักวิชา' + group + '</td></tr>');
                                last = group;
                            }
                        });
            ...
            function showall() {
                ...
                $.ajax({
                    url: '<?php echo site_url('ReportDataDivisionsDisciplineOfficer/showall') ?>',
                    type: 'GET',
                    async: false,
                    dataType: 'json',
                    data: data,
