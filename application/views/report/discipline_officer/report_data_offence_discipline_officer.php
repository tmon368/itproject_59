    ...
    <div class="container-fluid">
            ...
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card shadow mb-4">
                    ...
                    <div class="HeaderReport">
                        ...
                        <br>
                        <h2>
                            <center>รายงานนักศึกษาที่กระทำความผิดจำแนกตามฐานความผิด ประจำเดือน <span class="MontsNameYear"></span>
                        </h2>
                        </center>
        ...
        <script type="text/javascript">
            ...
            function showall() {
                ...
                $.ajax({
                    url: '<?php echo site_url('ReportDataOffenceDisciplineOfficer/showall') ?>',
                    type: 'GET',
                    async: false,
                    dataType: 'json',
                    data: data,
