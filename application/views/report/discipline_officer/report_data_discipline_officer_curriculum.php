...
<script>
    $(document).ready(function() {
        ...
        function showAll() {
            $.ajax({
                type: 'ajax',
                url: '<?php echo base_url() ?>index.php/ReportDisciplineOfficerCurriculum/showAll',
                async: false,
                dataType: 'json',
        ...
        $('#search_data').click(function() {
            ...
            $.ajax({
                url: '<?php echo site_url('officer_cur/getCUR_ID') ?>',
                type: 'GET',
                async: false,
                dataType: 'json',
                data:data,
