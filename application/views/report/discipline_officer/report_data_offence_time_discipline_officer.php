...
<script>
    $(document).ready(function() {
        ...
        function showAll() {
            $.ajax({
                type: 'ajax',
                url: '<?php echo base_url() ?>index.php/ReportDisciplineOfficerOffenceTime/showAll',
                async: false,
                dataType: 'json',
    ...
    $('#search_data').click(function(data) {
        ...
        $.ajax({
            ...
            url: '<?php echo site_url('ReportDisciplineOfficerOffenceTime/datebetween') ?>',
            type: 'post',
                async: false,
                dataType: 'json',
