    ...
    <div class="container-fluid">
        ...
        <div class="page-breadcrumb" id="nav_sty">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="<?php echo site_url('Discipline_officer_dashboard') ?>" class="breadcrumb-link">หน้าแรก</a></li>
            ...
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card shadow mb-4">
                    ...
                    <div class="HeaderReport">
                        ...
                        <br>
                        <h2>
                            <center>รายงานนักศึกษาที่กระทำความผิดจำแนกตามหมวดความผิด ประจำเดือน <span class="MontsNameYear"></span>
                        </h2>
                        </center>
                        ...
                        <colgroup>
                            ...
                            <thead class="table-active">
                                <tr>
                                    ...
                                    <th style="text-align:center">หมวดความผิด</th>
                                </tr>
                            </thead>
                        </table>
                        <br>
        ...
        <script type="text/javascript">
                ...
                $('#data_activity_participants').DataTable({
                    ...
                    "drawCallback": function(settings) {
                        ...
                        api.column(groupColumn, {
                            ...
                            if (last !== group) {
                                console.log(group);
                                $(rows).eq(i).before('<tr class="group HeaderGroup"><td colspan="9">'+'หมวด' + group + '</td></tr>');
                                last = group;
                            }
                        });
                        api.column(6, {
                            ...
                            if (last !== group) {
                                $(rows).eq(i).before(
                                    '<tr class="group"><td colspan="9">' + 'ฐานความผิด : ' + groupLink + '</td></tr>'
                                );
            ...
            function showall() {
                ...
                $.ajax({
                    url: '<?php echo site_url('ReportDataOffencecateDisciplineOfficer/showall') ?>',
                    type: 'GET',
                    async: false,
                    dataType: 'json',
                    data: data,
