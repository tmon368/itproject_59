            ...
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card shadow mb-4">
                    ...
                    <form action="" method="get" name="serach_form" id="serach_form">
                        ...
                        <div>
                                <select name="placeid" id="placeid"></select>
                            </div>
...
<p class="line">________________________________________________________________________________________________________________________________________________________________________________________________</p>
                    ...
                    <br>
                    <h3>
                        <center>รายงานนักศึกษาที่กระทำความผิด บริเวณ<span class="PlaceName"></span> </center>
                    </h3>
                    <h4>
...
<script>
    $(document).ready(function() {
        ...
        $('#search_data').click(function() {
            ...
            $.ajax({
                method: 'GET',
                url: '<?php echo site_url('ReportDataPlacePeriodTimeDisciplineOfficer/time_report_place') ?>',
                async: false,
                dataType: 'json',
                data: data,
