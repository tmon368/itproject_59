                ...
                <div class="card shadow mb-4">
                    ...
                    <form action="" method="get" name="serach_form" id="serach_form">
                        ...
                        <div class="col-lg-5 grid-margin stretch-card">
                            <div>
                                <select name="curid" id="curid"></select>
                            </div>
...
<p class="line">________________________________________________________________________________________________________________________________________________________________________________________________</p>
                    ...
                    <br>
                    <h3>
                        <center>รายงานนักศึกษาที่กระทำความผิด หลักสูตร<span class="CurriculumName"></span> </center>
                    </h3>
                    <h4>
...
<script>
    $(document).ready(function() {
        ...
        $('#search_data').click(function() {
            var CurriculumName = $("#curid option:selected").text();
            ...
            $.ajax({
                method: 'GET',
                url: '<?php echo site_url('ReportDataCurriculumPeriodTimeDisciplineOfficer/time_report_curriculum') ?>',
                async: false,
                dataType: 'json',
                data: data,
