...
<p class="line">________________________________________________________________________________________________________________________________________________________________________________________________</p>
                    ...
                    <table id="data_activity_participants" class="table table-striped table" style="width:100%">
...
<script>
    $(document).ready(function() {
        ...
        $('#search_data').click(function() {
            var DormitoryName = $("#deptid option:selected").text();
            ...
            $.ajax({
                method: 'GET',
                url: '<?php echo site_url('ReportDataDormitoryPeriodTimeDisciplineOfficer/time_report_dormitory') ?>',
                async: false,
                dataType: 'json',
                data: data,
