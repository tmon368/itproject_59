    ...
    <div class="container-fluid">
            ...
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card shadow mb-4">
                    ...
                    <div class="HeaderReport">
                        ...
                        <br>
                        <h2>
                            <center>รายงานนักศึกษาที่กระทำความผิดจำแนกตามหลักสูตร ประจำเดือน <span class="MontsNameYear"></span>
                        </h2>
                        </center>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                $('#data_activity_participants').DataTable({
                    ...
                    columns: [{
                        ...
                        {
                            data: 'off_desc',class: 'text-center'
                        },
                        {
                    ...
                    "drawCallback": function(settings) {
                        ...
                        api.column(groupColumn, {
                            ...
                            if (last !== group) {
                                console.log(group);
                                $(rows).eq(i).before('<tr class="group HeaderGroup"><td colspan="9">'+'หลักสูตร' + group + '</td></tr>');
                                last = group;
                            }
                        });
            ...
            function showall() {
                ...
                $.ajax({
                    url: '<?php echo site_url('ReportDataCurriculumDisciplineOfficer/showall') ?>',
                    type: 'GET',
                    async: false,
                    dataType: 'json',
                    data: data,
