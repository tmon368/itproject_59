...
<p class="line">________________________________________________________________________________________________________________________________________________________________________________________________</p>
                    ...
                    <br>
                    <h3>
                        <center>รายงานนักศึกษาที่กระทำความผิด สำนักวิชา<span class="DivisionsName"></span> </center>
                    </h3>
                    <h4>
...
<script>
    $(document).ready(function() {
        ...
        $('#search_data').click(function() {
            var DivisionsName = $("#deptid option:selected").text();
            ...
            $('.DivisionsName').text(DivisionsName);
            ...
            $.ajax({
                method: 'GET',
                url: '<?php echo site_url('ReportDataDivisionsPeriodTimeDisciplineOfficer/time_report_divisions') ?>',
                async: false,
                dataType: 'json',
                data: data,
