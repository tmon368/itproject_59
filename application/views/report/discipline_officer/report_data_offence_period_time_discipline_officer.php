...
<p class="line">________________________________________________________________________________________________________________________________________________________________________________________________</p>
                    ...
                    <br>
                    <h3>
                        <center>รายงานนักศึกษาที่กระทำความผิด ฐานความผิด <span class="OffenceName"></span> </center>
                    </h3>
                    <h4>
...
<script>
    $(document).ready(function() {
            ...
            example = $('#data_activity_participants').DataTable({
                ...
                "drawCallback": function(settings) {
                    ...
                    api.column(groupColumn, {
                        ...
                        if (last !== group) {
                            console.log(group);
                            $(rows).eq(i).before('<tr class="group HeaderGroup"><td colspan="9">' + group + '</td></tr>');
                            last = group;
                        }
                    });
                }
        ...
        $('#search_data').click(function() {
            ...
            $.ajax({
                method: 'GET',
                url: '<?php echo site_url('ReportDataOffencePeriodTimeDisciplineOfficer/time_report_offence') ?>',
                async: false,
                dataType: 'json',
                data: data,
