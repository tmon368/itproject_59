...
<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url('re/css/navigation.css'); ?>"> <!--navigate-->
  ...
  <link href="https://fonts.googleapis.com/css?family=Sarabun&display=swap" rel="stylesheet"> <!--เก็บใส่ folder-->
