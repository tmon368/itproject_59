    ...
    <div class="container-fluid">
        ...
        <div class="page-breadcrumb" id="nav_sty">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="<?php echo site_url("Student_dashboard") ?>"
                            class="breadcrumb-link">หน้าแรก</a></li>
        ...
        <div class="modal fade" id="form_notify" role="dialog" aria-labelledby="exampleModalCenterTitle"
            aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" style="max-width:1200px!important;"
                role="document">
                    ...
                    <form action="#" id="msform" name="msform" method="post" enctype="multipart/form-data" novalidate>
                        ...
                        <div class="modal-body">
                            <fieldset>
                                ...
                                <div class="form-card">
                                    ...
                                    <div class="Content">
                                        ...
                                        <div class="Content1">
                                            ...
                                            <div class="row">
                                                <label for="Date_notify"><span><i
                                                            class="far fa-calendar-alt iconlabel"></i></span>วันที่แจ้งเหตุ:</label>
                                                <input type="text" name="notifica_show" id="notifica_show" class="input"
                                                    disabled>
                                                <input type="hidden" name="notifica_date" id="notifica_date">
                                            </div>

                                            <div class="row">
                                                <label for="committed_date"><span><i
                                                            class="far fa-calendar-alt iconlabel"></i></span>วันที่กระทำความผิด:
                                                </label>
                                                <input type="date" name="committed_date" id="committed_date"
                                                    class="input data">
                                                <label for="" id="labletime">เวลา:</label> <input type="time"
                                                    name="committed_time" id="committed_time" class="input time">
                                            </div>

                                            <div class="row">
                                                <label for="place"><span><i
                                                            class="far fa-building iconlabel"></i></span>สถานที่:</label>
                                            ...
                                            <div class="row">
                                                <label for="place"><span><i
                                                            class="fa fa-commenting-o iconlabel"></i></span>คำอธิบายสถานที่:</label>
                                                <textarea class="textarea" rows="5" id="explanation"
                                        ...
                                        <div class="Content2">
                                            ...
                                            <div class="row">
                                                <label for="offcate"><span><i
                                                            class=" iconlabel"></i></span>หมวดความผิด:</label>
                                            ...
                                            <div class="row">
                                                <label for="off"><span><i
                                                            class=" iconlabel"></i></span>ฐานความผิด:</label>
                                ...
                                <input type="button" id="buttonnext1" name="next" class="next1 action-button"
                                    value="ถัดไป" />
                            </fieldset>
                                ...
                                <div class="form-card">
                                    <div class="Content">
                                        ...
                                        <div class="Content2">
                                            <div class="title2">
                                                <label for="off"><span><i
                                                            class=" iconlabel"></i></span>ผู้กระทำความผิด:</label>
                                            </div>
                                        ...
                                        <div class="Content1 filecontent">
                                            ...
                                            <div>
                                                <div class="upload-btn-wrapper">
                                                    ...
                                                    <input type="file" class="file_input" id="myFile" name="myFile[]"
                                                        multiple />
                                                </div>
                                            </div>
