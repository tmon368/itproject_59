      ...
      <div class="modal-body">
		  ...
		  <div class="form-group" id="input_group_sty" >
				<div class="input-group" >
					...
					&nbsp;&nbsp;&nbsp;
					<div class="col-lg-3">
                    <input type="text" name="userID"  class="form-control"  maxlength="2" onkeyup="count_down_id(this);" required>
    ...
    <h2 class="modal-title" id="exampleModalLongTitle"><span><i class="fas fa-edit" style="color:#47307b;"></i></span>แก้ไขข้อมูล</h2>
     ...
     <div class="form-group" id="input_group_sty" >
				<div class="input-group" >
					...
					&nbsp;&nbsp;&nbsp;
					<div class="col-lg-3">
                    <input type="text" name="typeeditID"  class="form-control"  maxlength="2" onkeyup="count_down_editid(this);" required>
          ...
          function count_down_editid(obj) {
              ...
              if (2 - obj.value.length == 0) {
				...
				<div class="input-group" >
					...
					<p class="text-danger">&nbsp;&nbsp;*</p>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <input type="text" name="typeeditname"  class="form-control"  maxlength="50" onkeyup="count_down_editname(this);" required>
				</div>
				<div class="form-group sty_a">
