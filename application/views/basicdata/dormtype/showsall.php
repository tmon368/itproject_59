...
("message").'</label></center>';  
                                ...
                                <center>
                                    <div class="form-group" id="input_group_sty">
                                        <div class="input-group">
                                            ...
                                            <div class="col-lg-3">
                                                <input type="text" name="txtID" class="form-control" maxlength="1"
    ...
    $(function() {
        ...
        $('#showdata').on('click', '.fa-edit', function() {
            ...
            '<?php echo base_url() ?>index.php/dormtype/updatedormtype');
            $.ajax({
                type: 'ajax',
                method: 'get',
        ...
        $('#showdata').on('click', '.fa-trash-alt', function() {
            ...
            '<?php echo base_url() ?>index.php/dormtype/deletedormtype');
            $.ajax({
                type: 'ajax',
                method: 'get',
                url: '<?php echo base_url() ?>index.php/dormtype/editdormtype',
