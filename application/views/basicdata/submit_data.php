...
<head>
	...
	<link rel="stylesheet" href="https://cdn.datatables.net/1.10.19/css/jquery.dataTables.min.css"> <!--โหลด CSS มาเก็บในโฟลเดอร์-->
...
<body>
	...
	<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.4.0/jquery.min.js"></script> <!--โหลด JavaScript มาเก็บในโฟลเดอร์-->
	<script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.14.7/umd/popper.min.js"></script> <!--โหลด JavaScript มาเก็บในโฟลเดอร์-->
	<script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js"></script> <!--โหลด JavaScript มาเก็บในโฟลเดอร์-->

	<!--JavaScript ส่วน DataTable-->
	<script src="https://code.jquery.com/jquery-3.3.1.js"> </script> <!--โหลด JavaScript มาเก็บในโฟลเดอร์-->
	<script src="	https://cdn.datatables.net/1.10.19/js/jquery.dataTables.min.js"> </script> <!--โหลด JavaScript มาเก็บในโฟลเดอร์-->
