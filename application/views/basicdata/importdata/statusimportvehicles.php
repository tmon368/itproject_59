...
<div class="page-breadcrumb" id="nav_sty">
  <nav aria-label="breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active" aria-current="page">การนำเข้าข้อมูลยานพาหนะ</li>
    </ol>
  </nav>
</div>
...
<div class="col-lg-12 grid-margin stretch-card">
  ...
  <div class="card shadow mb-4">
    ...
    <div class="card-header">
      <h6 class="m-0 text-primary"><span class="fas fa-download"></span>&nbsp;การนำเข้าข้อมูลยานพาหนะ</h6>
    </div>
