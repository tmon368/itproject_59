...
("message").'</label></center>';
            ...
            ?>
                    ...
                    <div id="menu2" class="container tab-pane fade"><br>
                      ...
                      <form action="<?php echo base_url(); ?>index.php/import_data/importoffensecate" method="post" enctype="multipart/form-data" name="form1">
                        <div class="form-group">
                          <input type="file" name="_fileup" id="_fileup" class="form-control-file border">
                          
                        </div>
                        <button type="submit" name="btn_submitoffensecate"class="btn btn-success btn-fw" style="font-family:'Prompt',sans-serif;">ยืนยัน</button>
                      </form>
                    </div>
                    ...
                    <div id="menu3" class="container tab-pane fade"><br>
                      ...
                      <form action="<?php echo base_url(); ?>index.php/import_data/importoffense" method="post" enctype="multipart/form-data" name="form1">
                        <div class="form-group">
                          <input type="file" name="_fileup" id="_fileup" class="form-control-file border">
                          
                        </div>
                        <button type="submit" name="btn_submitoffense"class="btn btn-success btn-fw" style="font-family:'Prompt',sans-serif;">ยืนยัน</button>
                      </form>
                    </div>
