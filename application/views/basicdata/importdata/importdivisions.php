           ...
           <h3> หน่วยงาน</h3><br>
			...
			<p style="color:#99A3A4;">**รองรับไฟล์ประเภท .csv ในการนำเข้าข้อมูลเข้าเพื่อลงฐานข้อมูล</p>
      		<p style="color:#99A3A4;">กรุณาเลือกไฟล์ที่ต้องการนำเข้า</p>
                ...
                <form action="<?php echo site_url() ?>/import_data/importdivisions" method="post" id="#" enctype="multipart/form-data">
                  <div class="form-group">
                    <input type="file" name="_fileup" id="_fileup"  required accept=".csv, .xls,.xlsx" />
                  </div>
                  <button type="submit" name="btn_submitdivisions" class="btn btn-success btn-fw" id="btn_submitdivisions">นำเข้า</button>
                </form>
